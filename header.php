                ...
                <nav class="nav-sidebar">
                    ...
                    <div class="nav-item">
                        <a href="#dataSubmenu" class="nav-link" data-bs-toggle="collapse" 
                           aria-expanded="<?= in_array(basename($_SERVER['PHP_SELF']), ['import.php', 'export.php', 'export_filter_simple.php', 'budget_manager.php', 'excel_api.php', 'vendor_manager.php']) ? 'true' : 'false' ?>">
                        ...
                        <div class="collapse <?= in_array(basename($_SERVER['PHP_SELF']), ['import.php', 'export.php', 'export_filter_simple.php', 'budget_manager.php', 'excel_api.php', 'vendor_manager.php']) ? 'show' : '' ?>" id="dataSubmenu">
                            <!-- Import Section -->
