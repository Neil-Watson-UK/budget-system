...
if (!isset($_SESSION['user_id'])) {
    header('Location: login.php?redirect=' . urlencode('form_manager.php'));
    exit;
}
...
$region_groups = ['AMER', 'DACH', 'UKI', 'APAC', 'ANZ', 'NORD', 'BNL', 'FRANCE', 'EMEA_PARTNERS', 'INDIA'];
...
<head>
    ...
    <title>Form Manager - <?= APP_NAME ?></title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/core@1.0.0-beta20/dist/css/tabler.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@2.40.0/tabler-icons.min.css">
    <style>.region-badge { font-size: 0.7rem; padding: 0.25rem 0.5rem; } .table-actions { white-space: nowrap; }</style>
</head>
<body>
    ...
    <div class="container-xl">
        <div class="page-header d-print-none mb-4">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title"><i class="ti ti-list-details me-2"></i>Form Field Manager</h2>
                    <div class="text-muted mt-1">Manage dropdown options for add-item form (accounts, staff, vendors, activities, etc.)</div>
                </div>
            </div>
        </div>
        
        <?php if (isset($_GET['success'])): ?>
        <div class="alert alert-success alert-dismissible fade show"><i class="ti ti-check me-2"></i>Settings updated successfully!<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
        <?php endif; ?>
        <?php if (isset($import_message)): ?>
        <div class="alert alert-info alert-dismissible fade show"><i class="ti ti-info-circle me-2"></i><?= $import_message ?><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
        <?php endif; ?>
        
        <div class="card mb-4">
            <div class="card-header">
                <h4 class="mb-0"><i class="ti ti-sliders me-2"></i>Form Field Options Manager</h4>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h6 class="mb-0"><i class="ti ti-upload me-2"></i>Bulk Import Options</h6>
                </div>
        <div class="card-body">
            <div class="row">
                <!-- Accounting Codes -->
                <div class="col-md-6 mb-4">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" name="bulk_import" class="btn btn-warning">
                            <i class="ti ti-upload me-2"></i>Import Accounting Codes
                        </button>
                    </form>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" name="bulk_import" class="btn btn-warning">
                            <i class="ti ti-upload me-2"></i>Import Sub Accounting Codes
                        </button>
                    </form>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" name="bulk_import" class="btn btn-warning">
                            <i class="ti ti-upload me-2"></i>Import Budget Activities
                        </button>
                    </form>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" name="bulk_import" class="btn btn-warning">
                            <i class="ti ti-upload me-2"></i>Import MDF Activities
                        </button>
                    </form>
                </div>
            </div>
...
<div class="col-md-6 mb-4">
    ...
    <form method="POST">
        ...
        <button type="submit" name="bulk_import" class="btn btn-warning">
            <i class="ti ti-upload me-2"></i>Import Staff Members
        </button>
    </form>
</div>
...
<div class="col-12 mb-4">
    <div class="card border-info">
        <div class="card-header bg-info text-white">
            <h6 class="mb-0"><i class="ti ti-file-spreadsheet me-2"></i>Import Vendors from Spreadsheet</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="import_vendors" class="btn btn-info">
                            <i class="ti ti-file-import me-2"></i>Import Channel Vendors
                        </button>
                    </form>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="import_vendors" class="btn btn-info">
                            <i class="ti ti-file-import me-2"></i>Import External Vendors
                        </button>
                    </form>
                </div>
            </div>
            ...
            <div class="mt-4 p-3 bg-light rounded">
                <h6><i class="ti ti-info-circle me-2"></i>CSV Format Guide</h6>
            ...
            <div class="mt-3">
                <a href="download_template.php?type=vendor_with_id" class="btn btn-outline-primary btn-sm">
                    <i class="ti ti-file-code me-1"></i>Download CSV Template with Vendor IDs
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="fieldTypeTabsContent">
                    ...
                    <div class="tab-pane fade <?= $type === 'accounting_code' ? 'show active' : '' ?>" 
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h6 class="mb-0"><i class="ti ti-plus me-2"></i>Add New <?= $label ?></h6>
                            </div>
                            <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center text-muted py-4">
                                            <i class="ti ti-inbox mb-2 d-block"></i>
